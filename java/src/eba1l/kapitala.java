...
public class kapitala {
	public static void main(String[]args) {
		...
		System.out.println("zure interesa %" +interesa+ "-koa da.");//borobilduta
		System.out.printf("Erantzuna %% %.2f", (diru_kantitatea * Interes_tasa * denbora_tartea)/(360*100));//borobilgabe
	}
}
